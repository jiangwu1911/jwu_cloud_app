        ...
        if (role == '系统管理员') {
            data = { menuitems: 
                    [{id:1, text:'帐号管理', iconCls:'menu_admin', parent_id:null, className:null},
                     ...
                     {id:12, text:'物理服务器', iconCls:'menu_host', parent_id:11, className:'machines'},
                     {id:13, text:'计算资源', iconCls:'menu_hypervisor', parent_id:11, className:'hypervisors'},
                     {id:14, text:'日志', iconCls:'menu_log', parent_id:11, className:null},
